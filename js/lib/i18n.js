...
const DICTS = {
  es: {
    ...
    differential: {
      ...
      subtitle: 'A partir de una tabla tipo DESeq2/ANCOM-BC (taxón, log2FoldChange, padj): volcano, lollipop o mapa de calor, con generador de script de R.',
  ...
  en: {
    ...
    differential: {
      ...
      subtitle: 'From a DESeq2/ANCOM-BC-style table (taxon, log2FoldChange, padj): volcano, lollipop or heatmap, with an R script generator.',
