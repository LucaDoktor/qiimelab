...
const GLOSSARY = [
  ...
  },
  {
    ...
    terms: [
      ...
      { id: 'pcoa', route: 'beta' },
      { id: 'upgma', route: 'beta' },
      { id: 'rda', def: 'beta.rdaDisclaimer', route: 'beta' },
      { id: 'cca', def: 'beta.rdaDisclaimer', route: 'beta' },
      { id: 'venn', route: 'venn' },
  ...
  },
  {
    ...
    terms: [
      ...
      { id: 'ancombc', def: 'barplots.bmMethodAncombcDesc', route: 'barplots' },
      { id: 'randomforest', def: 'barplots.bmMethodRfDesc', route: 'barplots' },
