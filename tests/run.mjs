...
const SUITE = [
  ...
  { name: 'pcoa-ellipses', file: 'pcoa-ellipses.mjs', kind: 'navegador' },
  { name: 'violin', file: 'violin.mjs', kind: 'navegador' },
  ...
  { name: 'stats/confidenceellipse', file: 'stats/confidenceellipse.mjs', kind: 'R' },
